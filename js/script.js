...
function initContactSlider() {
    ...
    const contacts = [
        { icon: "fa-envelope", title: "Email", subtitle: "Drop me a message", link: "mailto:ak06598909@gmail.com", linkText: "Send", copy: "arham@example.com", isCopy: true },
        { icon: "fa-phone", title: "Phone", subtitle: "Call anytime", link: "tel:+923003020167", linkText: "Call", copy: "+923003020167", isCopy: true },
        { icon: "fab fa-linkedin-in", title: "LinkedIn", subtitle: "Connect professionally", link: "https://www.linkedin.com/in/arhamkhannn/", linkText: "Visit", copy: null, isCopy: false },
        { icon: "fab fa-github", title: "GitHub", subtitle: "Check my code", link: "https://github.com/arhamkhan779", linkText: "View", copy: null, isCopy: false },
        { icon: "fa-briefcase", title: "Upwork", subtitle: "Hire me for freelance", link: "https://www.upwork.com/freelancers/~01f4fb31dfb4a7a60e?mp_source=share", linkText: "Hire", copy: null, isCopy: false }
    ];
...
function initProjectSlider() {
    ...
    projects.forEach(p => {
        ...
        card.innerHTML = `
            ${p.video ? `<div class="video-container">
                <video class="project-video" controls muted><source src="${p.video}" type="video/mp4">Your browser does not support the video tag.</video>
                <button class="video-toggle-btn" title="Fullscreen"><i class="fas fa-expand"></i></button>
            </div>` : ''}
    ...
    setTimeout(() => {
        ...
        // Initialize video expand/collapse functionality
        initVideoToggle();
...
function initVideoToggle() {
    ...
    toggleButtons.forEach(btn => {
        btn.addEventListener('click', function(e) {
            e.stopPropagation();
            const videoElement = this.closest('.video-container').querySelector('video');
